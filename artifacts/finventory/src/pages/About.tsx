...
const milestones = [
  {
    year: "2018",
    title: "Founded",
    desc: "Started with a mission to simplify business management for Indian SMEs.",
  },
  {
    year: "2019",
    title: "GST Integration",
    desc: "First platform to offer end-to-end GST filing integration in India.",
  },
  {
    year: "2020",
    title: "100 Customers",
    desc: "Crossed 100 paying customers during the pandemic — proving cloud software's value.",
  },
  {
    year: "2021",
    title: "Series A Funding",
    desc: "Raised ₹25 crore to expand our product and team.",
  },
  {
    year: "2022",
    title: "Enterprise Launch",
    desc: "Launched enterprise tier serving businesses with 500+ employees.",
  },
  {
    year: "2023",
    title: "500+ Businesses",
    desc: "Crossed 500 active business customers across 7 industries.",
  },
  {
    year: "2024",
    title: "AI-Powered Analytics",
    desc: "Launched AI-powered business insights and forecasting module.",
  },
];

const team = [
  {
    name: "Mahesh Puttapaka",
    role: "Co-founder & CEO",
    bio: "GST Practitioner with 8+ years of experience in Indian Accounting and Taxation.",
  },
];
...
const values = [
  {
    ...
    desc: "Every feature we build starts with a customer problem.",
  },
  {
    icon: Shield,
    title: "Trust & Transparency",
    desc: "Your data belongs to you. No hidden fees. No surprises.",
  },
  {
    icon: TrendingUp,
    title: "Continuous Innovation",
    desc: "We ship meaningful updates every two weeks without exception.",
  },
  {
    icon: Heart,
    title: "Built for India",
    desc: "Indian tax laws, Indian languages, Indian business workflows — built in.",
  },
];
    ...
    >
      ...
      <section className="pt-32 pb-20 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          >
            <div className="text-[#06B6D4] text-sm font-semibold uppercase tracking-wider mb-3">
              Our Story
            </div>
            ...
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              Finventory was born out of frustration —
              watching Indian businesses struggle with
              fragmented, expensive, and outdated software.
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-4 text-white/60 leading-relaxed">
              <p>
                In 2018, I started my journey as a CA
                intern with a salary of just ₹3,000 per
                month. Coming from a humble family, every
                rupee mattered. While many saw it as a
                small beginning, for me it was the first
                step toward a bigger dream.
              </p>

              <p>
                During my internship, I worked with
                multiple businesses — traders,
                manufacturing companies, and service-based
                firms. Every office taught me something
                new: accounting, taxation, GST, payroll,
                business operations, client handling, and
                most importantly, how real businesses
                survive and grow.
              </p>

              <p>
                The work was hard. Long hours, pressure
                during filings, and balancing studies with
                responsibilities became part of everyday
                life. But those struggles built
                discipline, patience, and confidence in
                me.
              </p>

              <p>
                In 2020, after completing my CA
                internship, I joined as a Junior
                Accountant. Slowly, my career started
                growing. I gained experience, handled
                clients independently, and understood the
                financial problems faced by businesses at
                every level.
              </p>

              <p>
                But deep inside, I always had a bigger
                vision — not just to work for businesses,
                but to build one.
              </p>

              <p>
                My biggest inspiration has always been my
                father. Coming from a poor family, he
                spent his entire life working hard to
                support us and fulfill his
                responsibilities. Despite financial
                struggles, he successfully managed the
                marriages of my four sisters and kept the
                family together with sacrifice and
                determination.
              </p>

              <p>
                Watching his journey taught me the true
                meaning of hard work, responsibility, and
                never giving up. His struggles became my
                motivation.
              </p>

              <p>
                That is where the dream of building
                Finventory started — a mission to help
                businesses with accounting, taxation, ERP
                solutions, and financial services in a
                smarter and more affordable way.
              </p>

              <p>
                Today, the journey is still continuing.
                From earning ₹3,000 a month as an intern
                to building a vision for entrepreneurs,
                every step reminds me that small
                beginnings can create big stories.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            {[
              {
                ...
                label: "Mission",
                color: "#2563EB",
                text: "To give every Indian business — from a kirana store to a manufacturing company — access to enterprise-grade software that actually works for how Indian businesses operate.",
              },
              {
                icon: Eye,
                label: "Vision",
                color: "#06B6D4",
                text: "A future where every business decision is backed by real data. Where accounting, inventory, and payroll don't consume your week. Where business owners spend time building, not managing software.",
              },
            ].map((mv) => (
              <motion.div
                key={mv.label}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {team.map((member, i) => (
              ...
              >
                ...
                <div className="text-[#06B6D4] text-xs mb-3">
                  {member.role}
                </div>
      ...
      <section className="py-20 text-center border-t border-white/5">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <p className="text-white/50 mb-8">
            Talk to us. We genuinely love hearing from
            businesses who are on the same journey.
          </p>

          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/book-demo"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#2563EB] to-[#1d4ed8] text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 transition-all"
            >
              Book a Demo
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 text-white font-semibold rounded-xl hover:bg-white/5 transition-all"
            >
              Contact Us
            </Link>
          </div>
